...
import { AlertCircle, Calendar, CheckCircle, Clock, Copy, Edit, Tag, Trash2, X } from 'lucide-react'
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span
                className={`text-sm px-2 py-1 rounded font-medium ${getStatusBadgeClass(template.status)}`}
              >
