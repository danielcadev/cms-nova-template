...
import { Calendar, Crown, Shield, TrendingUp, Users } from 'lucide-react'
          ...
          {statsData.map((stat, index) => (
            ...
            >
              <div className="flex items-center justify-between mb-ios">
                <div
                  className={`w-12 h-12 bg-gradient-to-br ${stat.gradient} rounded-ios-lg flex items-center justify-center`}
                >
                ...
                {stat.trend && (
                  <div className="flex items-center gap-1 px-2 py-1 bg-ios-success/10 rounded-ios text-ios-success">
                    ...
                    <span className="ios-caption font-sf-text font-semibold">
                      +{stat.trend.value}%
                    </span>
                  </div>
                )}
