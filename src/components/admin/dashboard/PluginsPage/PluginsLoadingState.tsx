  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-1/3 right-1/4 w-24 h-24 bg-gradient-to-br from-slate-400/10 to-blue-300/10 rounded-full blur-xl animate-pulse"
      ...
      <div className="text-center relative z-10">
        ...
        <div className="space-y-4 mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Preparando las extensiones disponibles...
          </p>
        </div>
      </div>
    </div>
