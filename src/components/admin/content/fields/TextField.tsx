...
export function TextField({
  ...
  return (
    <div className="space-y-2">
      <div className={`relative transition-all duration-200 border rounded-xl overflow-hidden ${
        isFocused 
          ? 'ring-2 border-[var(--theme-accent)]' 
        ...
        {showCounter && length > 0 && (
          <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium`}
              style={{
                backgroundColor: isNearLimit ? 'var(--theme-accent-light)' : 'var(--theme-bg-secondary)',
