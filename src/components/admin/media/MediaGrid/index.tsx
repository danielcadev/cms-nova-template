...
export function MediaGrid({
  ...
  const handleCopy = (event: MouseEvent<HTMLElement>, item: MediaItem) => {
    ...
    navigator.clipboard
      ...
      .catch(() =>
        toast.error({ title: t('grid.copyFailedTitle'), description: t('grid.copyFailedDesc') }),
      )
  }
                ...
                <div className="flex flex-col gap-4">
                  <div className="rounded-2xl border theme-border bg-theme-bg-secondary/60 p-4 text-sm">
                    <dl className="space-y-2">
                      ...
                      <div className="flex justify-between gap-3">
                        <dt className="text-neutral-500 dark:text-neutral-400">
                          {t('grid.details.folder')}
                        </dt>
                        <dd className="font-medium theme-text">
                          {preview.folder || t('grid.details.root')}
                        </dd>
                      </div>
                      {preview.createdAt && (
                        <div className="flex justify-between gap-3">
                          <dt className="text-neutral-500 dark:text-neutral-400">
                            {t('grid.details.uploaded')}
                          </dt>
                          <dd className="font-medium theme-text">
