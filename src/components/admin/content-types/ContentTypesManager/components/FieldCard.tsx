...
export function SortableFieldCard({ field, onDelete }: SortableFieldCardProps) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`group relative bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow ${sortableIsDragging ? 'shadow-lg scale-105 opacity-50' : ''
        }`}
    >
      <div className="p-4">
