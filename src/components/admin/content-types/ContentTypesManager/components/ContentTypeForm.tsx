...
} from '@/modules/content/content-type-actions'
    ...
    if (presetType === 'seo-article') {
      const seoFields = [
        ...
        },
        {
          id: Math.random().toString(36).slice(2, 9),
          label: 'Canonical URL',
          apiIdentifier: 'canonicalUrl',
          type: 'TEXT',
          isRequired: false,
        },
        {
          id: Math.random().toString(36).slice(2, 9),
          label: 'Is Featured/Pillar',
          apiIdentifier: 'isFeatured',
          type: 'BOOLEAN',
          isRequired: false,
        },
      ]
      ...
      const blogFields = [
        ...
        {
          id: Math.random().toString(36).slice(2, 9),
          label: 'Introduction (Content 1)',
          apiIdentifier: 'content1',
          type: 'RICH_TEXT',
          isRequired: true,
        },
        {
          id: Math.random().toString(36).slice(2, 9),
          label: 'Gallery 1',
          apiIdentifier: 'image1',
          type: 'MEDIA',
          isRequired: false,
          isList: true,
        }, // List support enabled

        // Content Block 2 (Deep Dive)
        {
          id: Math.random().toString(36).slice(2, 9),
          label: 'Deep Dive (Content 2)',
          apiIdentifier: 'content2',
          type: 'RICH_TEXT',
          isRequired: false,
        },
        {
        ...
        {
          id: Math.random().toString(36).slice(2, 9),
          label: 'Conclusion (Content 3)',
          apiIdentifier: 'content3',
          type: 'RICH_TEXT',
          isRequired: false,
        },
        ...
        // Classification
        {
          id: Math.random().toString(36).slice(2, 9),
          label: 'Región',
          apiIdentifier: 'regionName',
          type: 'SELECT',
          isRequired: false,
          options: 'Amazonas,Andina,Caribe,Orinoquía,Pacífico,Insular',
        },
        {
          id: Math.random().toString(36).slice(2, 9),
          label: 'Subregión',
          apiIdentifier: 'subRegionName',
          type: 'SELECT',
          isRequired: false,
        },
        {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-[2.5rem] border border-zinc-200/50 p-6 shadow-sm">
                <h3 className="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-4 ml-1">
                  {t('quickTemplates')}
                </h3>
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      <span className="block font-bold text-sm tracking-tight mb-0.5">
                        {t('seoArticle')}
                      </span>
