  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 mt-4">
      <div className="space-y-4">
        <div>
          <label htmlFor={labelId} className="block text-sm font-medium text-gray-700 mb-2">
            Etiqueta del Campo
          </label>
          <Input
            id={labelId}
        ...
        <div>
          <div className="block text-sm font-medium text-gray-700 mb-2">Tipo de Campo</div>
          <Select value={selectedType} onValueChange={setSelectedType}>
            <SelectTrigger
              aria-label="Tipo de Campo"
              className="rounded-lg border-gray-300 focus:border-blue-600 focus:ring-1 focus:ring-blue-600 h-auto py-3"
            >
              <SelectValue asChild>
                <div className="flex items-center gap-3 w-full">
                  {(() => {
                    ...
                    return (
                      <>
                        <div
                          className={`p-2 rounded-lg bg-gradient-to-br ${selectedTypeData.color} flex-shrink-0`}
                        >
                ...
                return (
                  <SelectItem key={type.value} value={type.value} className="rounded-lg my-1 p-3">
                    <div className="flex items-start gap-3 w-full">
                      <div
                        className={`p-2.5 rounded-lg bg-gradient-to-br ${type.color} flex-shrink-0`}
                      >
                        <IconComponent className="h-5 w-5 text-white" />
                      </div>
        ...
        <div className="flex items-center justify-between bg-gray-50 rounded-lg p-3">
          <div className="flex items-center space-x-3">
            ...
            />
            <div>
              <label htmlFor={requiredId} className="text-sm font-medium text-gray-700">
                Campo requerido
              </label>
