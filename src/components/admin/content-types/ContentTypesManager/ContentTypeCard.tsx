        ...
        <div className="relative">
          ...
          {contentType.fields.length > 0 && (
            <div className="mb-8">
              <div className="flex flex-wrap gap-2">
                {contentType.fields.slice(0, 4).map((field, _idx) => (
          ...
          <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
            ...
            <Link href={`/admin/dashboard/content-types/${contentType.apiIdentifier}/content`}>
              <button
                type="button"
                className="px-4 py-2.5 bg-[#30D158]/10 backdrop-blur-sm text-[#30D158] rounded-2xl hover:bg-[#30D158]/20 transition-all font-medium text-sm border border-[#30D158]/20 hover:border-[#30D158]/30 shadow-sm hover:shadow-md"
              >
