  ...
  return (
    <div className="space-y-6">
      {fields.map((item, index) => (
        <div
          key={item.id}
          className="bg-white dark:bg-gray-900 p-6 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm space-y-4"
        >
              ...
              <AlertDialogContent className="bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-800">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="pl-13 pt-2 text-gray-600 dark:text-gray-400">
                    Esta acción no se puede deshacer. Se eliminará permanentemente el día{' '}
                    {index + 1} y toda su información asociada.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        {...field}
                        placeholder="Ej: Llegada a Cancún y tarde libre"
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        {...field}
                        placeholder="Detalla las actividades, traslados, comidas y otra información relevante para este día."
                        rows={5}
