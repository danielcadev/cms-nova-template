...
export const PricingSection = memo(function PricingSection() {
  ...
  const handleAddPriceOption = useCallback(() => {
    if (newCurrency === 'USD' && newPersons < 2) {
      toast({
        title: 'Mínimo 2 personas',
        description: 'Para planes en dólares, el número mínimo de personas es 2.',
        variant: 'destructive',
      })
      return
    }
    if (newPersons <= 0) {
      toast({
        ...
        description: 'El número de personas debe ser mayor que cero.',
        variant: 'destructive',
      })
      return
    }
    if (
      ...
      toast({
        ...
        description: `Ya existe una opción de precio para ${newPersons} personas en ${newCurrency}.`,
        variant: 'destructive',
      })
      return
    }
