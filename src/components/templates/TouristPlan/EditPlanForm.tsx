...
const SectionWrapper = ({
  ...
  <Collapsible defaultOpen={defaultOpen}>
    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-700">
      ...
      <CollapsibleContent className="p-6 pt-0">{children}</CollapsibleContent>
    </div>
  </Collapsible>
)
          ...
          >
            ...
            <main className="flex-1 p-8">
              <div className="max-w-7xl mx-auto space-y-8">
                <SectionWrapper
                  icon={
                    <Info className="h-5 w-5 text-gray-600 dark:text-gray-400" strokeWidth={1.5} />
                  }
                ...
                <SectionWrapper
                  icon={
                    <Check className="h-5 w-5 text-gray-600 dark:text-gray-400" strokeWidth={1.5} />
                  }
